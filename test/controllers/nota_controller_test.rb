...
class NotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notum" do
    assert_difference("Notum.count") do
      post nota_url, params: { notum: { conteudo: @notum.conteudo, user_id: @notum.user_id } }
    end
  ...
  test "should update notum" do
    patch notum_url(@notum), params: { notum: { conteudo: @notum.conteudo, user_id: @notum.user_id } }
